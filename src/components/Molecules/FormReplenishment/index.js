...
const FormReplenishment = ({ setModalTicket }) => {
  ...
  const userActive = userParsed.credential.accountId;
            ...
            <form onSubmit={handleSubmit} className="container-fluid m-0 p-5 ">
              <div className="row">
                <div className="col-sm-12 p-0">
                  <h3 className={`${styles.h2From}`}>Datos de Contacto</h3>
                      ...
                      <div className="py-1 ">
                        <div className="form-group">
                          <label htmlFor="sellerName" className="w-100">
                            <p className="mb-2">Nombre Seller</p>
                            <input
                              type="text"
                      ...
                      <div className="py-1 ">
                        <div className="form-group">
                          <label htmlFor="contactName" className="w-100">
                            <p className="mb-2">Nombre de contacto</p>
                            <input
                              type="text"
                              className="form-control disabled"
                ...
                <div className="col-sm-12 p-0 mb-3 mt-2">
                  ...
                  <div className="row mb-2">
                    ...
                    <div className="col-4 col-sm-6 m-0 ps-5">
                      <div className="py-1 ">
                        <div className="form-group">
                          <p className="mb-2">Hora de tu Programación *</p>
                          <DatePicker
                            dateFormat="h:mm aa"
                            showTimeSelect
                            selected={startDate}
              ...
              <div className="row mb-3">
                <div className="col-sm-12 p-0">
                  <h3 className={`${styles.h2From}  pt-4`}>
                    Carga tus archivos
                  </h3>
                  <div className="row ">
                    <hr className="mx-" />
                    <div className="col-8 col-sm-6 m-0 pe-5 pt-2">
                      <div className="py-1 ">
                        <div className="form-group">
                          <p className="w-20">Facturas y/o Guía de despacho</p>
                          <DropZone
                    ...
                    <div className="col-4 col-sm-6 m-0 ps-5 pt-2">
                      <div className="py-1 ">
                        <div className="form-group">
                          <p className="w-20">Planilla de Reposición</p>
                          <UploadCsv
                            size="small"
                          ...
                          {dataWhitErrors.length > 0 && (
                            <p className="text-danger">
                              Tu archivo tiene campos vacíos, llénalos para
                              continuar...
                            </p>
                          )}
                        </div>
                  ...
                  <div className="row mt-0">
                    {error.contactEmail && (
                      <span className="text-danger">
                        No existen datos, por favor contáctanos
                      </span>
                    )}
                    <div className="col-8 col-sm-6">
                      <div className="py-1 ">
